...
public class RegisterActivity extends Activity {
	...
	void submit()  //SUBMIT按钮功能
	{
		...
		Request request = Server.requestBuliderWithApi("register")
							.method("post", null)
	...
	void onResponse(Call arg0, String responseBody)//注册成功
	{
	...
	void onFailure(Call arg0, Exception arg1)//注册失败
	{
		new AlertDialog.Builder(this)
		.setTitle("请求失败")
